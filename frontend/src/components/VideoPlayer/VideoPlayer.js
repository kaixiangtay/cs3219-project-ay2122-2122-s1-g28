...
function VideoPlayer() {
    ...
    return (
        <Grid>
            ...
            <Grid>
                <img alt='Profile2' src={webcam ? Profile : NUSociaLife_Login_logo} className={styles.videoSize}/>
                <div>
                    <IconButton onClick={handleMic} className={styles.videoSettingButton}>
                        <FontAwesomeIcon icon={mic ? faMicrophone : faMicrophoneSlash} />
                    </IconButton>
                    <IconButton onClick={handleWebCam} className={styles.videoSettingButton}>
