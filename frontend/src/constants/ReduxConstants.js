...
// Navigation
export const FINDFRIENDS = 1;
export const FORUM = 2;
export const PROFILE = 3;
...
export const PROFILE_RETRIEVE_FAILURE = 31;
export const PROFILE_UPDATE_SUCCESS = 32;
export const PROFILE_UPDATE_FAILURE = 33;
export const PROFILE_IMAGE_UPLOAD_SUCCESS = 34;
...
export const GET_USER_COMMENTS_SUCCESS = 62;
export const GET_USER_COMMENTS_FAILURE = 63;
export const DELETE_COMMENT_SUCCESS = 64;
export const DELETE_COMMENT_FAILURE = 65;
export const EDIT_COMMENT_SUCCESS = 66;
...
export const MATCHED_SUCCESS = 81;
export const MATCHED_FAILURE = 82;
export const UNMATCHED_SUCCESS = 83;
export const UNMATCHED_FAILURE = 84;
export const UPDATE_INTEREST_GENDER = 85;
export const UPDATE_INTEREST_SPORT = 86;
export const UPDATE_INTEREST_ART = 87;
export const UPDATE_INTEREST_MUSIC = 88;
export const UPDATE_INTEREST_FACULTY = 89;
